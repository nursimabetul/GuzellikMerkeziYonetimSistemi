...
namespace GuzellikMerkeziYonetimSistemi.Controllers
{
    public class PersonelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Adi,Soyadi,GSM,EmailAdres,DogumTarihi,Adres")] Personel personel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adi,Soyadi,GSM,EmailAdres,DogumTarihi,Adres")] Personel personel)
        {
            if (id != personel.Id)
            {
                return NotFound();
