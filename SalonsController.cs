...
namespace GuzellikMerkeziYonetimSistemi
{
    public class SalonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SalonAdi,Adres")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SalonAdi,Adres")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
